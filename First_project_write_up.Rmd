...
1. We also use 10-fold cross-validation to estimate the average prediction error of each of the 5 models, and the RMSE metric allows us to directly compare the models and select the best model that minimize RMSE. 
