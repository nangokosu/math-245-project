...
```{r}
## From Khai: this won't do because df1 only has 12 observations
...
From Khai: describe the country and year variable as well.
...
From Khai: provide commentary for your results: which variables were selected? How does this compare to my model (where only the the first three PCs are selected)? (If you want to, feel free to extract the results from the pr_decomposition for comparison. The object is pr_happiness)? What is the adjusted R_2 and AIC of my model (lm_model_final_cv) against yours?