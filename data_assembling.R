library(tidyverse)
parliament_data <- read_csv("parliament.csv")
happy_data <-read_csv("hapiscore_whr.csv")
unemployment_data<-read_csv("aged_15plus_unemployment_rate_percent.csv")
right_data <-read_csv("right.csv")
sanitation_data <- read_csv("sanitation.csv")
hdi_data <-read_csv("hdi.csv")
edu_data <- read_csv("edu.csv")
internet_data <- read_csv("internetusers.csv")
sdi_data <- read_csv("sdi.csv")
hdi_data <- read_csv("hdiindex.csv")
forest_data <- read_csv("forestcoverage.csv")
militaryexpenditure_data <- read_csv("militaryexpenditure.csv")
mortality_data <- read_csv("mortality.csv")
water_data <- read_csv("wateraccess.csv")
broadband_data <- read_csv("broadband.csv")
agriculture_data <- read_csv("agriculture.csv")
debt_data <- read_csv("debt.csv")
gdp_data <- read_csv("gdppercapita.csv")
food_data <- read_csv("foodinsecurity.csv")
...
full_data2 <- filter(full_data, year==2014)
